...
class ProductController extends Controller
{
    ...
    public function almatyIn(Request $request)
    {
        ...
        if (Auth::user()->type === 'almatyin'){
            ...
            $city_value = 'Получено на склад Гагарина';
            $reg_field = 'reg_almaty';
        }elseif (Auth::user()->type === 'kulagerin'){
            $city_field = 'to_city';
            $city_value = 'Получено на складе в мкр.Кулагер 7';
            $city = 'мкр.Кулагер 7';
            $reg_field = 'reg_city';
    ...
    {
        return Excel::download(new AllUsersExport(), 'all-users.xlsx');
    }
